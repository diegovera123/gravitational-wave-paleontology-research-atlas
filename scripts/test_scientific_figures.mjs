...
const required=["wave","kick","chirp","selection","transfer","pipeline","binary","cosmic","orbitalEnergy","detector","wind","weights","bayesian","imf","collapse","quadrupole","spacetime","metallicity","cluster","sampling"];
...
assert.match(figures.render("imf"),/initial-mass probability/);
assert.match(figures.render("collapse"),/core to compact-remnant/);
assert.match(figures.render("quadrupole"),/half an orbit/);
assert.match(figures.render("spacetime"),/proper times/);
assert.match(figures.render("metallicity"),/metallicity mixtures/);
assert.match(figures.render("cluster"),/Dense stellar environment/);
assert.match(figures.render("sampling"),/sparse times/);
...
console.log("Passed: accessible, explicitly non-empirical science illustrations for 20 figure routes, module load order and long-form reader controls.");
