...
const required=["wave","kick","chirp","selection","transfer","pipeline","binary","cosmic"];
...
console.log("Passed: accessible, non-empirical physics schematics for 8 illustration routes, module load order, continuous-reader progress and back-to-top controls.");
