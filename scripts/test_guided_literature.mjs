...
assert.ok(constellation.includes("concept-learning-goals-title")&&constellation.includes("concept-explanation-title"),"Objectives and explanation exist in the same learning unit");
assert.ok(!constellation.includes("concept-dialog-tabs"),"No separate content tabs");
assert.ok(constellation.indexOf("concept-learning-goals-title")<constellation.indexOf("concept-explanation-title"),"Objectives are before explanation in markup");
assert.ok(constellation.indexOf("concept-explanation-title")<constellation.indexOf("concept-resources-title"),"Resources follow the explanation");
